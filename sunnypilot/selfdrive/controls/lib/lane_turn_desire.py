...
class LaneTurnController:
  def __init__(self, desire_helper):
    ...
    self.nav_turn_direction = custom.ModelDataV2SP.TurnDirection.none
    self.nav_enabled = False

    # Navigation-based lane positioning
    self.nav_lane_positioning_direction = custom.ModelDataV2SP.TurnDirection.none
  ...
  def update_nav_turn(self, nav_state) -> None:
    ...
    if nav_state.active and nav_state.shouldSendTurnDesire:
      ...
      if turn_dir_int == custom.ModelDataV2SP.TurnDirection.turnLeft:
        self.nav_turn_direction = custom.ModelDataV2SP.TurnDirection.turnLeft
      elif turn_dir_int == custom.ModelDataV2SP.TurnDirection.turnRight:
        self.nav_turn_direction = custom.ModelDataV2SP.TurnDirection.turnRight
      else:
        self.nav_turn_direction = custom.ModelDataV2SP.TurnDirection.none
  ...
  def update_nav_lane_positioning(self, nav_state) -> None:
    ...
    if nav_state.active and nav_state.shouldSendLanePositioning:
      ...
      if lane_pos_dir_int == custom.ModelDataV2SP.TurnDirection.turnLeft:
        self.nav_lane_positioning_direction = custom.ModelDataV2SP.TurnDirection.turnLeft
      elif lane_pos_dir_int == custom.ModelDataV2SP.TurnDirection.turnRight:
        self.nav_lane_positioning_direction = custom.ModelDataV2SP.TurnDirection.turnRight
      else:
        self.nav_lane_positioning_direction = custom.ModelDataV2SP.TurnDirection.none
  ...
  def get_lane_positioning_direction(self):
    ...
    if self.nav_lane_positioning_enabled and self.nav_lane_positioning_direction != custom.ModelDataV2SP.TurnDirection.none:
  ...
  def get_turn_direction(self):
    ...
    if self.nav_enabled and self.nav_turn_direction != custom.ModelDataV2SP.TurnDirection.none:
